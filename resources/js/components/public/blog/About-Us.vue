    ...
    <section id="content">
      <div class="container">
        <div class="row">
          ...
          <div class="span6">
            ...
            <div class="flexslider">
              <ul class="slides">
                <li>
                  <img src="/assets/public/img/works/full/image-01-full.jpg" alt="" />
                </li>
                <li>
                  <img src="/assets/public/img/works/full/image-02-full.jpg" alt="" />
                </li>
                <li>
                  <img src="/assets/public/img/works/full/image-03-full.jpg" alt="" />
                </li>
              </ul>
            </div>
              <!-- end flexslider -->
        ...
        <div class="row">
          ...
          <div class="span3">
            <img src="/assets/public/img/dummies/team1.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
            <img src="/assets/public/img/dummies/team2.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
            <img src="/assets/public/img/dummies/team3.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
            <img src="/assets/public/img/dummies/team4.jpg" alt="" class="img-polaroid" />
            <div class="roles">
              <p class="lead">
